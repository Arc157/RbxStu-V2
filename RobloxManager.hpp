...
#define MakeSignature_FromIDA(signatureName, idaSignature)                                                             \
    ...
    namespace StudioSignatures {
        ...
        MakeSignature_FromIDA(RBX_DataModel_getStudioGameStateType,
            ...
            "48 8B 4F 50 48 85 C9 74 08 E8 8E E3 26 FE 48 8B F8 48 85 FF 75 0E B8 04 00 00 00 48 83 C4 20 5F C3 48 8B "
            "F9 48 89 5C 24 30 48 8B 5F 18 E8 2A 79 05 00 0F B7 93 84 03 00 00 48 8B 5C 24 30 0F B7 88 84 03 00 00 0F "
