...
#define MakeSignature_FromIDA(signatureName, idaSignature)                                                             \
    ...
    namespace StudioSignatures {
        ...
        MakeSignature_FromIDA(RBX_DataModel_getStudioGameStateType,
            "8B 81 ? ? ? ? C3 CC CC CC CC CC CC CC CC CC 40 57 48 83 EC 20 48 85 C9 74 "
            "1F 48 8B 79 50 48 85 FF 74 21 48 8B 4F 50 48 85 C9 74 08 E8 0E 41 1D FE 48 "
            "8B F8 48 85 FF 75 0E B8 04 00 00 00 48 83 C4 20 5F C3 48 8B F9 48 89 5C 24 30 48 8B 5F 18 E8 2A 79 05 00");
        ...
        MakeSignature_FromIDA(RBX_Instance_pushInstance,
            "48 89 5C 24 ? 57 48 83 EC ? 48 8B FA 48 8B D9 E8 ? ? ? ? 48 8B CB 84 C0 74 12 48 8B D7 48 8B 5C 24 ? 48 83 C4 ? 5F E9 ? ? ? ?");
